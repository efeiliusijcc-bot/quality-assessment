    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/etl/cleaning-rules/**").hasAnyRole("ADMIN", "ENGINEER")
                .requestMatchers("/api/etl/cleaning-logs").hasAnyRole("ADMIN", "ENGINEER")
                .requestMatchers("/api/etl/import-jobs/**").hasAnyRole("ADMIN", "ENGINEER", "OPERATOR")
